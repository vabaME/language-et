#!/bin/bash
#coreutils
sudo install -Dm644  systemd.mo /usr/share/locale-langpack/et/LC_MESSAGES/
sudo install -Dm644  ufw.mo /usr/share/locale-langpack/et/LC_MESSAGES/
...
sudo install -Dm644  udisks2.mo /usr/share/locale/et/LC_MESSAGES/
